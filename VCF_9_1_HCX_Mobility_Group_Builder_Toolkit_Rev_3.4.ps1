<#
.SYNOPSIS
  VCF 9.1 HCX Mobility Group Builder Toolkit Rev 3.4.2-Completion-and-Policy-Fix.ps1
.DESCRIPTION
...
<TabItem Header="4. Storage"><Grid Margin="8"><Grid.RowDefinitions><RowDefinition Height="Auto"/><RowDefinition Height="*"/></Grid.RowDefinitions>
...
$script:gridStorageRows.Add_CellEditEnding({Invalidate-Validation 'Storage configuration edited'})
